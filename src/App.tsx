			...
			<div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
				{languages.map((lang) => (
					<a
						...
						className="rounded-2xl border border-slate-800/70 bg-slate-900/40 p-5 hover:bg-slate-900/80 hover:border-slate-700 transition-all"
					>
						<div
							className={`w-10 h-10 mb-4 rounded-lg bg-gradient-to-br ${lang.color}`}
						/>
...
function Footer() {
	return (
		<footer
			className="max-w-5xl mx-auto px-6 py-10 border-t border-slate-800/60 text-center text-sm text-slate-500"
			style={{ fontFamily: "Space Mono, monospace" }}
		>
